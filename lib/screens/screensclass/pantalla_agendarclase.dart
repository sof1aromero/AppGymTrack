...
class __ModalSeleccionHorarioState extends State<_ModalSeleccionHorario> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<HorarioDetalle> currentHorarios = horariosHoy;

    String today = "Hoy (10 junio)";
    String tomorrow = "Mañana (11 junio)";
                    ...
                    child: ElevatedButton(
                      onPressed: canReserve
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text("Clase reservada: ${widget.clase.nombre} a las $_selectedTime")),
                        );
                      }
                          : null,
                      style: ElevatedButton.styleFrom(
